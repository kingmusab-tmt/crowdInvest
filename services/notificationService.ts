...
export async function getNotifications(): Promise<Notification[]> {
  ...
  const notificationList = notificationSnapshot.docs.map(
  ...
  const initialNotificationsData: Omit<Notification, "id">[] = [
    {
      ...
      description:
        "Just a friendly reminder that the Annual Community Reunion is next week! We can't wait to see you all there.",
      target: "All Users",
    ...
    },
    {
      ...
      description:
        "We are looking for volunteers to help with the upcoming Southside Annual Festival. Please sign up if you're available.",
      target: "Southside",
    ...
    },
    {
      ...
      description:
        "Hi Olivia, your welcome gift is ready for pickup at the community center. Congratulations on joining!",
