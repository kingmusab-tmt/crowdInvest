            ...
            <CardHeader>
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <CardDescription>
                    Owned by {business.ownerName} &bull; {business.location}
                  </CardDescription>
                </div>
            ...
            <Card className="bg-primary/5 border-primary/20">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-primary">
                  <Star className="h-4 w-4" /> Seeking Investment
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-primary/80 mb-4">
                  This business is looking for funding from the community. A
                  formal investment proposal will be available for voting soon.
                </p>
